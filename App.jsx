  ...
  return (
    <div className="container">
      ...
      <div className="form-group">
        ...
        <input type="number" value={guestCount} onChange={(e) => setGuestCount(e.target.value)} placeholder="Enter number of guests" />
      </div>
      <div className="form-group">
      ...
      <button onClick={addOrUpdateReservation}>{editingIndex !== null ? 'Update Reservation' : 'Make Reservation'}</button>
            ...
            <tr key={index}>
              ...
              <td>
                {reservation.status === 'Checked In' ? (
                  <button className="btn-checkout" onClick={() => checkoutReservation(index)}>Check Out</button>
                ) : (
                  <button disabled>Checked Out</button>
                )}
                <button className="btn-edit" onClick={() => editReservation(index)}>Edit</button>
                <button className="btn-delete" onClick={() => deleteReservation(index)}>Delete</button>
              </td>
            </tr>
          ))}
        </tbody>
